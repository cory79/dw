        ...
        .controller("userController",
                function($scope) {
                    ...
                    $scope.impostaEtichette = function() {
                        ...
                        $scope.mostro.Etichette = uniq($scope.mostro.Etichette_list.filter(function(n) {return n !== undefined;}));
                        
                        $scope.mostro.EtichetteAttacco = uniq($scope.mostro.EtichetteAttacco_list.filter(function(n) {return n !== undefined;}));
                        
                        $scope.mostro.PF_list = $scope.mostro.PF_list.filter(function(n) {return n !== undefined;});
                        $scope.mostro.PF=$scope.mostro.PF_list.sum();
                        
                        $scope.mostro.Armatura_list = $scope.mostro.Armatura_list.filter(function(n) {return n !== undefined;});
                        $scope.mostro.Armatura=$scope.mostro.Armatura_list.sum();
                        
                        $scope.mostro.DannoPerforante_list = $scope.mostro.DannoPerforante_list.filter(function(n) {return n !== undefined;});
                        $scope.mostro.DannoPerforante=$scope.mostro.DannoPerforante_list.sum();
                        
                        if ($scope.mostro.sceltaBranco >= 0) {
                            $scope.mostro.Attacco_list = $scope.mostro.Attacco_list.filter(function(n) {return n !== undefined;});
                            $scope.mostro.Dado_list = $scope.mostro.Dado_list.filter(function(n) {return n !== undefined;});
                            $scope.mostro.DoppioTiro_list = $scope.mostro.DoppioTiro_list.filter(function(n) {return n !== undefined;});
                    ...
                    $scope.mostro = {
                        ...
                        DannoPerforante: 0,
                        branco: [
                            {Codice: "orda", Testo: "In grandi gruppi: <i>orda, d6 danni, 3 PF</i>", Checked: false, Tag: "orda", PF: 3, Dado: 1},
                            {Codice: "gruppi", Testo: "In piccoli gruppi, da 2 a 5 componenti: <i>gruppo, d8 danni, 6 PF</i>", Checked: false, Tag: "gruppo", PF: 6, Dado: 2},
                            {Codice: "solitario", Testo: "Tutto da solo: <i>solitario, d10 danni, 12 PF</i>", Checked: false, Tag: "solitario", PF: 12, Dado: 3}
